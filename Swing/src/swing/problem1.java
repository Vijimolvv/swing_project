...
frame.setBounds(100, 100, 947, 385);
...
btnPie.addActionListener(new ActionListener() {
	public void actionPerformed(ActionEvent e) {
		...
		//String Number=t1.getText()+bdiv.getText();
		//t1.setText(Number);
	...
	//	t1.setText(a1);
		...
		//String Number=t1.getText()+btnPie.getText();
	//t1.setText(Number);
	}
});
...
mntmScientifc.addActionListener(new ActionListener() {
	public void actionPerformed(ActionEvent e) {
		frame.setBounds(100, 100, 576, 600);
	}
});
...
panel.setBounds(570, 32, 329, 302);
frame.getContentPane().add(panel);
panel.setLayout(null);

t2 = new JTextField();
t2.setBounds(112, 139, 151, 37);
panel.add(t2);
t2.setColumns(10);
...
btnNewButton_5.setBounds(53, 265, 89, 23);
...
btnNewButton_6.setBounds(216, 265, 89, 23);
